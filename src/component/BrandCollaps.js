                        ...
                        <Col lg={4} className="brands">
                                <Accordion defaultActiveKey="0" flush>
                                        <Accordion.Item eventKey="0">
                                            ...
                                            <Accordion.Body>
                                                <p>A brand is more than just a logo and color palette. We'll craft a distinct visual and verbal identity, create necessary assets, and establish clear brand guidelines to maintain consistency across all
                                                    touchpoints. </p>
                                            </Accordion.Body>
                                        </Accordion.Item>
                                        <Accordion.Item eventKey="1">
                                            ...
                                            <Accordion.Body>
                                                <p>Clay concentrates on designing authentic connections through the use of both aesthetics and behavioral science. Our team of senior UI/UX designers delivers engaging digital products that help brands thrive in the modern economy.</p>
                                            </Accordion.Body>
                                        </Accordion.Item>
                                    ...
                                    <Accordion.Item eventKey="4" onMouseEnter={handleHover}
                                        ...
                                        <Accordion.Body>
                                            <p>Content is a crucial aspect of the user experience, and we offer a range of services to support this, including copywriting, illustration, 2D and 3D graphics, iconography, animation, video production, and photography.
                                            </p>
                                        </Accordion.Body>
                                    </Accordion.Item>
                                </Accordion>
